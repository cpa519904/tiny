...
var demo_themes = [
  { name: 'default', title: '默认', img: tinywebroot+'/demo/themes/default.png' },
  { name: 'clean',  title: '深色', img: tinywebroot+'/demo/themes/dark.png' },
  { name: 'asphalt', title: '沥青', img: tinywebroot+'/demo/themes/asphalt.png' },
  { name: 'purple-hills', title: '紫色', img: tinywebroot+'/demo/themes/purple-hills.png' },
  { name: 'adminflare',  title: '深蓝', img: tinywebroot+'/demo/themes/deep-blue.png' },
  { name: 'dust',  title: '橙色', img: tinywebroot+'/demo/themes/orange.png' },
  { name: 'frost',  title: '浅蓝', img: tinywebroot+'/demo/themes/light-blue.png' },
  { name: 'fresh',  title: '绿色', img: tinywebroot+'/demo/themes/green.png' },
  { name: 'silver',  title: '黑色', img: tinywebroot+'/demo/themes/black.png' },
  { name: 'white',  title: '时尚', img: tinywebroot+'/demo/themes/fashion.png' }
];
...
if (demo_settings.footer_fixed) {
	//alert("test")
  document.body.className = document.body.className + ' footer-fixed';
}
//collapsed
